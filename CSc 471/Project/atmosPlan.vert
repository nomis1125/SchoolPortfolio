...
void main()
{
	...
	vec3 v3FrontColour2 = vec3(0.0, 0.0, 0.0);
	vec3 v3Attenuate;
	...
	for(int i = 0; i<nSamples; i++){
		...
		v3FrontColour2 += v3Attenuate * (fDepth * fScaledLength);
		v3SamplePoint += v3SampleRay;
	}

	outData.c00RGB = v3FrontColour2 * (v3InvWavelength * fKrESun + fKmESun);;
	outData.c01RGB = v3Attenuate;
