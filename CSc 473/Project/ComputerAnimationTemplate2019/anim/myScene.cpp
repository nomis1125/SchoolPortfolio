...
void MakeScene(void)
{
	...
	*/
	...
	Oscillation* gravitySimulator2 =
		new Oscillation("oscillation", sphere1);

	success = GlobalResourceManager::use()->addSimulator(gravitySimulator2);
	...
	sampleSimulatorRetrieval = 
		GlobalResourceManager::use()->getSimulator( "oscillation" );
