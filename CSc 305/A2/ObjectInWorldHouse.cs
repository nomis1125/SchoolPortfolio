...
public class ObjectInWorldHouse : MonoBehaviour {
	
	// Use this for initialization
	void Start () {
		GameObject origHouse = GameObject.Find("house_3");
		...
		origHouse.transform.position = new Vector3(posHouse.x, newY*cs.maxHeight+4, posHouse.z);
